    ...
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                ...
                <a href="#myModal" role="button" class="btn btn-primary" data-toggle="modal">Add Menu</a>
    ...
    <div class="modal-dialog modal-full" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="result">
                <form action="{{ route('menu_add') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-12">
                            <input type="submit" name="submit" value="Upload" class="w-100 btn btn-primary">
                        </div>
                    </div>
                </form>
            </div>
