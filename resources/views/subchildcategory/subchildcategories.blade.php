...
@section('title', 'Sub child Categories')
...
<div class="row clearfix">
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                <h2><strong>Category</strong> List<small>Add Class <code>.thead-dark</code></small></h2>
                <ul class="header-dropdown">
                    <a href="{{ route ('subchildcategory.create') }}" class="btn btn-gradient-primary btn-fw">Add Category</a>
                ...
                <div class="table-responsive">
                    <table class="table m-b-0">
                        <thead class="thead-dark">
                            <tr>
                            <th scope="col">#</th>
                            <th scope="col">subchild Category Name </th>
