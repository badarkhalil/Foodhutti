    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            <div class="header">
                ...
                <a href="{{ route ('subcategory.index') }}" class="btn btn-gradient-primary btn-fw">Back to Category</a>
            ...
            <div class="body">
                <form action="{{ route('restaurant.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" id="subcategory_name" name="subcategory_name" class="form-control" placeholder="Enter Category Name  ">
                    </div>
