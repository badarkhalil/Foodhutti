    ...
    <ul class="navbar-nav">
        ...
        <li class="dropdown">
            <a href="javascript:void(0);" class="dropdown-toggle" title="Notifications" data-toggle="dropdown" role="button"><i class="zmdi zmdi-notifications"></i>
                <div class="notify"><span class="@if(count($count) > 0) heartbit @endif"></span><span class="@if(count($count) > 0) point @endif"></span></div>
            </a>
            <ul class="dropdown-menu slideUp2">
                <li class="header">Notifications ({{ count($count) }})</li>
                <li class="body">
                    <ul class="menu list-unstyled">
                        @foreach ($user->unreadNotifications as $notification )
                        <li>
                            <a href="{{ route('viewsinglerestaurant',$notification->data["restaurant_id"]) }}">
                                <div class="icon-circle bg-purple"><i class="zmdi zmdi-refresh"></i></div>
                                <div class="menu-info">
                                    <h4>New Restaurant: <b>{{ $notification->data['name'] }}</b></h4>
                                    <p><i class="zmdi zmdi-time"></i> {{ $notification->created_at }} </p>
                                </div>
                            </a>
                        </li>
                        @endforeach
                ...
                <li class="footer"> <a href="{{ route('readall') }}">Mark All Read</a> </li>
            </ul>
        </li>
        {{--
        <li class="dropdown">
        ...
        <li><a href="{{ route('change_password') }}" class="app_group_work" title="Change Password"><i class="zmdi zmdi-group-work"></i></a></li>
