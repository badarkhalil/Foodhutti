    ...
    <div class="col-md-12">
        <div class="card">
            <div class="header">
                ...
                <a href="#myModal" role="button" class="btn btn-primary" data-toggle="modal">Add Buffet Menu</a>
    ...
    <div class="modal-dialog modal-full" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="result">
                <form action="{{ route('buffet_add') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
